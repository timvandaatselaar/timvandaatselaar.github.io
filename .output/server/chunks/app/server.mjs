...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "bg-white antialiased dark:bg-slate-900 dark:text-white" }, _attrs))}>`);
