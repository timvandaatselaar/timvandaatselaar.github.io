import { hasInjectionContext, getCurrentInstance, useSSRContext, createApp, reactive, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, inject, toRef, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, mergeProps, nextTick, defineComponent, ref, h, Suspense, Transition } from 'file:///Users/tim/projects/timvandaatselaar.github.io/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/tim/projects/timvandaatselaar.github.io/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/tim/projects/timvandaatselaar.github.io/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/tim/projects/timvandaatselaar.github.io/node_modules/unctx/dist/index.mjs';
import { createMemoryHistory, createRouter, START_LOCATION, RouterView } from 'file:///Users/tim/projects/timvandaatselaar.github.io/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///Users/tim/projects/timvandaatselaar.github.io/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL } from 'file:///Users/tim/projects/timvandaatselaar.github.io/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///Users/tim/projects/timvandaatselaar.github.io/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file:///Users/tim/projects/timvandaatselaar.github.io/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-a3037fd1.mjs').then((m) => m.default || m)
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white antialiased dark:bg-slate-900 dark:text-white" }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-234f3d2f.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-ea0fb97d.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-6fc128b0.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
