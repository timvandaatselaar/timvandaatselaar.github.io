...
import require$$0, { reactive, getCurrentInstance, ref, computed, defineComponent, resolveComponent, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, useSSRContext, h, Suspense, Transition, isRef, shallowRef, mergeProps, createApp } from "vue";
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSuspense, ssrRenderAttrs } from "vue/server-renderer";
...
const vueuseHead_2ae2c780 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_7cf65798 = defineNuxtPlugin((nuxtApp) => {
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_RouterView, _attrs, {
    default: withCtx(({ Component }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(Component), { key: $setup.key }, null), _parent2, _scopeId);
      } else {
        return [
          (openBlock(), createBlock(resolveDynamicComponent(Component), { key: $setup.key }))
        ];
      }
    }),
    _: 1
...
const NuxtNestedPage = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3]]);
const Fragment = {
  setup(_props, { slots }) {
    ...
    return () => {
      return h(vueRouter_cjs_prod.RouterView, {}, {
        default: ({ Component, route }) => {
          var _a;
          return Component && wrapIf(Transition, (_a = route.meta.pageTransition) != null ? _a : defaultPageTransition, wrapInKeepAlive(route.meta.keepalive, h(Suspense, {
...
const router_0a7f956b = defineNuxtPlugin((nuxtApp) => {
